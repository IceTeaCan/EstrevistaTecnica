...
if(isset($_POST["crearAlumno"]))
{
    ...
    if(empty($cedula)||empty($nombre)||empty($apellido_1)||empty($apellido_2)||empty($email)|| !is_numeric($cedula))
    {
        ...
        try
        {
            ...
            $soli = $layer->Inser_Alumno([$cedula,$nombre,$apellido_1,$apellido_2,$email]);
        }catch(Exception $e){
            $_SESSION['error_message'] = 'Ha ocurrido un error: ' . $e->getMessage();
            header('Location: 404.php');
            exit;
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="row">  
                    <h1 class="h3 mb-2 text-gray-800">Crear un nuevo alumno</h1>            
                </div>
                <p>Formato: Porfavor asegurese de ingresar la cédula de forma correcta pues no podrá ser modificada después. No se permiten letras en la cédula.</p>  
              </div>
              <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <form role="form" method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">            
                                ...
                                <button type="submit" name="crearAlumno" class="btn btn-primary"><i class="fas fa-cog"></i> Crear Alumno</button>  
